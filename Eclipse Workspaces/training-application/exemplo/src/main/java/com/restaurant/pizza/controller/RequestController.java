...
public class RequestController {
	...
	@PostMapping(value = "/create/{pizzaId}/{userId}")
	public void createRequest(@PathVariable Long pizzaId, @PathVariable Long userId) {
		requestService.makeRequest(pizzaId, userId);
	}
